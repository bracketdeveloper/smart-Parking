                                ...
                                <form class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-12">
                                        <fieldset class="row mb-6">
                                            <legend class="col-form-label col-sm-4 pt-0">Select Type</legend>
                                            <div class="col-sm-10">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="recover-type" value="admin" checked>
                                                    <label class="form-check-label" for="gridRadios1">
                                                        Admin
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="recover-type" value="staff">
                                    ...
                                    <div class="col-12">
                                        <div class="form-label">
                                            <span class="form-check-label"><a href="login.php"
                                                >Login!</a></span>

                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100" id="btn-recover-password"
                                                onclick="return validateRecoverPassword()">Recover Password
                                        </button>
                                    </div>
                                </form>
